...
st.markdown("<p style='text-align': justify;>FIFA19 is the official football game of EA Sports. FIFA 19 is a football simulation video game developed 
...
26th installment in the official FIFA series by EA SPORTS™.</p>")
